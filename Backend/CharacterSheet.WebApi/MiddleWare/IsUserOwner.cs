...
using CharacterSheet.WebApi.Controllers;
...
public class IsUserOwner : IAsyncActionFilter
{
	...
	public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
	{
		...
		if (((ControllerActionDescriptor) context.ActionDescriptor).ActionName != nameof(CharactersController.Get) 
			&& context.ActionArguments.ContainsKey("id") 
			&& context.ActionArguments["id"] is long id)
		{
